package com.tengzhi.business.cg.yw.purchaseSettle.service;
...
public interface PurchaseSettleService extends BaseService {
	...
	BasePage<Map<String, Object>> getBottomList(BaseDto baseDto)throws IOException;
