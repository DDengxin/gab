package com.tengzhi.business.finance.financialBooks.subsidiaryAccount.service.impl;
...
import com.tengzhi.business.finance.financialBooks.subsidiaryAccount.dao.SubsidiaryAccountDao;
...
@Service
@Transactional
public class SubsidiaryAccountServiceImpl implements SubsidiaryAccountService {


    @Autowired
    private SubsidiaryAccountDao subsidiaryAccountDao;
    ...
    public BasePage<payment> findAll(BaseDto baseDto) throws IOException, ParseException {
        ...
        return subsidiaryAccountDao.QueryToBeanPage(baseDto, sql);
    }
}
