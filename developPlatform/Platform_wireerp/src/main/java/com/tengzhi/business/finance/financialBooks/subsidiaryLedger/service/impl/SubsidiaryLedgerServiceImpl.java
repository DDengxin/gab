package com.tengzhi.business.finance.financialBooks.subsidiaryLedger.service.impl;
...
import com.tengzhi.business.finance.financialBooks.subsidiaryLedger.dao.SubsidiaryLedgerDao;
...
public class SubsidiaryLedgerServiceImpl implements SubsidiaryLedgerService {
    ...
    @Autowired
    private SubsidiaryLedgerDao subsidiaryLedgerDao;
    ...
    public BasePage<payment> findAll(BaseDto baseDto) throws IOException, ParseException {
        ...
        return subsidiaryLedgerDao.QueryToBeanPage(baseDto, sql);
    }
}
