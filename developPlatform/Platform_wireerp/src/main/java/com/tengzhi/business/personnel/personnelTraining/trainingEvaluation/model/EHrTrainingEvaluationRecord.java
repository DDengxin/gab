package com.tengzhi.business.personnel.personnelTraining.trainingEvaluation.model;
...
public class EHrTrainingEvaluationRecord extends BaseModel {
    @Id
    ...
    private String jlType,jlPlanNote,jlTitle,
            ...
            jlTrainingEffect,jlTrainingCost,
            dataMan,dataCorp;
    ...
    public EHrTrainingEvaluationRecord(){
