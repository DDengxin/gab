package com.tengzhi.business.ck.yw.kctj.service;
...
public interface WarehouseKcService  {
	...
	BasePage<Map<String, Object>> getUnitList(BaseDto baseDto) throws IOException;
