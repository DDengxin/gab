package com.tengzhi.business.platform.form.model;
...
@Entity
@Table(name = "g_dynamic_form_detail")
public class DynamicFormDetail {
	...
	public String getAssociatedFormKey() {
		return associatedFormKey;
	}

	public void setAssociatedFormKey(String associatedFormKey) {
		this.associatedFormKey = associatedFormKey;
	}
