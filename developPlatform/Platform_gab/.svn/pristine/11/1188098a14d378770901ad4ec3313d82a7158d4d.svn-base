package com.tengzhi.business.platform.order.service.impl;

import cn.hutool.core.util.ObjectUtil;
import com.tengzhi.base.jpa.dto.BaseDto;
import com.tengzhi.base.jpa.page.BasePage;
import com.tengzhi.base.security.common.model.SessionUser;
import com.tengzhi.business.platform.order.dao.G_EXsContractDao;
import com.tengzhi.business.platform.order.dao.G_EXsContractDetailedDao;
...
public class OrderServiceImpl implements OrderService {
	...
	@Autowired
	private G_EXsContractDao eXsContractDao;
	
	@Autowired
	private G_EXsContractDetailedDao eXsContractDetailedDao;
	...
	@Override
	public BasePage<G_EXsContract> findAll(BaseDto baseDto) throws IOException {
		String where="";
		...
		String sqlString = " select a.ht_no,a.ht_date,f_get_param_name('订单类型',a.ht_type,'cn')ht_type,f_get_param_name('订单类型',a.ht_item_type,'cn')ht_item_type,f_getname('GETUSERNAME',a.ht_customer,'',a.data_corp)ht_customer,f_get_param_name('业务员',c.customer_buyer,'')data_man,sum(b.ht_sl)ht_sl,sum(b.ht_je)ht_je,a.ht_flag from e_xs_contract A left join e_xs_contract_detailed b on A.ht_no = b.ht_no left join sys_customer C on A.ht_customer = C.customer_id where 1=1 ";
		if(ObjectUtil.isNotEmpty(map.get("accessType"))) {
			if(map.get("accessType").equals("客户")) {
				where+=" and a.ht_customer = '"+user.getUserId()+"'";
				sqlString += where + " group by a.ht_no,a.ht_date,a.ht_type,a.ht_item_type,a.ht_customer,c.customer_buyer,a.ht_flag,a.data_corp order by ht_date desc,ht_no desc";
			}else if(map.get("accessType").equals("供应商")) {
				String supply_id = eXsContractDao.QueryFirstString("select supply_id from sys_user where user_id = '"+user.getUserId()+"'");
				where+=" and supply_id = '"+supply_id+"'";
				sqlString = " select a.ht_no,a.ht_date,f_get_param_name('订单类型',a.ht_type,'cn')ht_type,f_get_param_name('订单类型',a.ht_item_type,'cn')ht_item_type,f_getname('GETUSERNAME',a.ht_customer,'',a.data_corp)ht_customer,f_get_param_name('业务员',c.customer_buyer,'')data_man,sum(b.ht_sl)ht_sl,sum(b.ht_je)ht_je,a.ht_flag from e_xs_contract A left join e_xs_contract_detailed b on A.ht_no = b.ht_no left join sys_customer C on A.ht_customer = C.customer_id left join (select sys_user.supply_id,e_js_cpcode.cpcode_id from sys_user,e_js_cpcode where e_js_cpcode.data_man = sys_user.user_id) supply on supply.cpcode_id = b.ht_code  where 1=1 ";
				sqlString += where + " group by a.ht_no,a.ht_date,a.ht_type,a.ht_item_type,a.ht_customer,c.customer_buyer,a.ht_flag,a.data_corp order by ht_date desc,ht_no desc";
			}
		}
...
//	@Override
//	public BasePage<G_EXsContractDetailed> getScddList(BaseDto baseDto) throws IOException {
//		Map<String, String> map = baseDto.getParamsMap();
...
//	
	@Override
	public G_EXsContract findByNote(String htNote) {
		return eXsContractDao.QueryListModel(G_EXsContract.class, "select a.*,f_getname('GETDWEXP',a.ht_customer,'',a.data_corp)ht_customer_name from e_xs_contract a where ht_no= :1 ", htNote).get(0);
	}
	
	@Override
	public BasePage<G_EXsContractDetailed> getSrchBottomList(BaseDto baseDto) throws IOException {
		Map<String, String> map = baseDto.getParamsMap();
		...
		String sqlString=" select a.ht_no,a.ht_mo,a.ht_id,a.ht_code,a.ht_sl,a.ht_price,a.ht_je,a.ht_jq,a.ht_sm,a.ht_flag,a.data_man,a.data_corp,a.ht_requirements,(select string_agg( param_name,',') from sys_param c where strpos(a.ht_standard,c.param_id)>0 and  c.param_mod='技术'  )ht_standard_name,ht_standard ,ht_customer_associated_remarks,ht_customer_associated " + 
				" ,f_getname ( 'CPCODENAME', b.cpcode_id, '', b.data_corp ) cpcode_name,b.cpcode_size ,b.cpcode_size_en,f_getparamname('GETBYCPCODEFL',b.cpcode_fl,'','技术',c.ht_stype,'')cpcode_fl,b.cpcode_bz,b.cpcode_xp,b.cpcode_check,b.cpcode01,b.cpcode02,b.cpcode03 from e_xs_contract_detailed a,e_js_cpcode b,e_xs_contract c "
