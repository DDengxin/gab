...
//        }
    ...
    @Override
    public Result getParamValueBottom() {
        String sql = "select v_sysparamtree.*,sys_param.param_value3 as url,sys_param.param_value1 as info,sys_param.param_value2 as button,sys_param.param_ord as px\n" +
                ...
                "where v_sysparamtree.parent_id ='PTINFO'";
        List<Map<String, Object>> maps = sysParamDao.QueryhumpMap(sql);
        return Result.resultOk(maps);
