...
public class SysParameterController { 
     ...
     */
    @Anonymous
    @GetMapping("/get/platformInfo")
    public  Result getBottonInfo(){
        return sysUserService.getParamValueBottom();
    }
    ...
    /**
     * 获取指定行业类型的动态参数配置
     * @param cpcodeType 行业分类(配置在技术-》行业参数下 exp:YL,WL,JG,XC...)
     * @return
     */
	 ...
	 * @param relatedBusiness 是否关联业务以过滤部分数据(仅对于取业务人员有效)
     * @return
     */
    ...
    /**
     * 通过参数模块、参数类型获取参数列表(树形结构)
     *
     * @param paramMod 参数模块
     * @param paramType 参数类型
     * @return
     */
    @PostMapping(value = "/getIndustryDynamicFieldParameters/{paramMod}/{paramType}")
    public List<SelectVo> getParamsTreeListByParamModAndParamType(@PathVariable(name = "paramMod") String paramMod,
                                                                  @PathVariable(name = "paramType") String paramType){
        return sysUserService.getParamsTreeListByParamModAndParamType(paramMod, paramType);
    }
    ...
    public List<SelectVo> getParamsSelectListByValue2(@PathVariable(name = "paramType") String paramType, @PathVariable(name = "paramValue2") String paramValue2) {
        return sysUserService.getParamsSelectListByValue2(paramType, paramValue2);
    }
    ...
    @GetMapping("getParamsSelectListByValue2AndValue3/{paramType}/{paramValue1}/{paramValue3}")
    public List<SelectVo> getParamsSelectListByValue1AndValue3(@PathVariable(name = "paramType") String paramType,@PathVariable(name = "paramValue1") String paramValue1,@PathVariable(name = "paramValue3") String paramValue3) {
        return sysUserService.getParamsSelectListByValue1AndValue3(paramType, paramValue1,paramValue3);
    }


    @GetMapping("/getCorpChainOrCorpProduction/{stype}")
    public List<SelectVo> getCorpChainOrCorpProduction(@PathVariable(name = "stype") String stype) {
        return sysUserService.getCorpChainOrCorpProduction(stype);
    }

    @GetMapping("/getParamValue2SelectList/{paramMod}/{paramType}")
    @Anonymous
    public List<SelectVo> getParamValue2SelectList(@PathVariable(name = "paramMod") String paramMod, @PathVariable(name = "paramType") String paramType) {
        return sysUserService.getParamValue2SelectList(paramMod, paramType);
    }
}
