...
var dToast = function(){};
dToast.prototype.config = function(config){
    if (typeof config == "string") {
        config = {title: "新消息", body: config,}
...
dToast.prototype.inner = function(config) {
    var date = new Date();
...
dToast.prototype.toast = function(config) {
    var self = this;
    ...
    if (window.Notification && Notification.permission !== "denied" && config.inner != true) {
        Notification.requestPermission(function (status) {
            if (status == "granted") {
                ...
                ;var d_toast_n = new Notification(config.title, _config);
