...
public class WarehouseKcServiceImpl implements WarehouseKcService {
    ...
    public BasePage<Map<String, Object>> getVStock(BaseDto dto) throws Exception {
        ...
        String sql = " select ck_mx.lib,ck_mx.inlibname, "
                ...
                +" ck_mx.cpcode_fl , "
                +"  ck_mx.cpcodeflname cpcode_fl_name,"
                +"  ck_mx.cpcode_size_en,"
                +"  ck_mx.cpcode_xp_name,"
                + " ck_mx.cpcode_xp "
                + " from v_ck_mx  ck_mx "
                ...
                + " ck_mx.in_contract, cpcode.cpcode02,ck_mx.cpcode_size_en, "
                +" ck_mx.cpcode_size, ck_mx.cpcode_bz,ck_mx.cpcodebzname,ck_mx.dtype,ck_mx.cpcode_fl,ck_mx.cpcodeflname,ck_mx.cpcode_xp ,ck_mx.cpcode_xp_name";
