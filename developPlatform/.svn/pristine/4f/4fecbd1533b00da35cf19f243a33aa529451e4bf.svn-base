...
public class BasicsDaoImpl<T, ID> implements BasicsDao<T, ID> {
    ...
    @Override
    public <V> List<V> query(String sql, Class<V> clazz, Map<String, Object> map) {
    ...
    @Override
    public <V> List<V> query(String sql, Class<V> clazz, String... params) {
        Query q = em.createNativeQuery(sql);
    ...
    public <V> List<V> query(String sql, Class<V> V) {
        Query q = em.createNativeQuery(sql);
