...
public interface paymentDao extends BasedaoRepository<payment, String>{
	...
	@Query(value = "select f_getname('GETDWEXP', :sfkdw, '', :datacorp)",nativeQuery = true)
	String getSfkdwname(@Param("sfkdw") String sfkdw,@Param("datacorp") String datacorp);
	
	payment findBySfkNote(String note); 
}
