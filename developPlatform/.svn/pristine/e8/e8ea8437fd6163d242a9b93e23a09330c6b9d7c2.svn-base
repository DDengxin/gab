package com.tengzhi.business.finance.financialBooks.auxiliaryBalanceSheet.service.impl;
...
import com.tengzhi.business.finance.financialBooks.auxiliaryBalanceSheet.dao.AuxiliaryBalanceSheetDao;
...
@Service
@Transactional
public class AuxiliaryBalanceSheetServiceImpl implements AuxiliaryBalanceSheetService {


    @Autowired
    private AuxiliaryBalanceSheetDao auxiliaryBalanceSheetDao;
    ...
    public BasePage<payment> findAll(BaseDto baseDto) throws IOException, ParseException {
        ...
        return auxiliaryBalanceSheetDao.QueryToBeanPage(baseDto, sql);
    }
}
