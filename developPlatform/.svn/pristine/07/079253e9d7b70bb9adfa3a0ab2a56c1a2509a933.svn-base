...
@IdClass(value = EckOutLsFlag.ECkOut_PK.class)
public class EckOutLsFlag {
	@Id
	private String outNote;
	@Id
	private String outPack;
	private String outCustomer, outAct, outCode, outBpack, outContract, outKfcontract, outKfcode, outLib, outCheckflag,
			outMonth, outType, outLuono, outVnote, outBz, outHs, outLyr;
	private String dataMan, dataCorp, outFlag, outMan, brand, outCklib,outPh,outKw;
	...
	public static class ECkOut_PK implements Serializable {
		...
		public boolean equals(Object obj) {
			...
			ECkOut.ECkOut_PK other = (ECkOut.ECkOut_PK) obj;
			if (outNote == null) {
				if (other.getOutNote() != null) {
					return false;
				}
			} else if (!outNote.equals(other.getOutNote())) {
				return false;
			}
			if (outPack == null) {
				return other.getOutPack() == null;
			} else {
				return outPack.equals(other.getOutPack());
			}
		}
	...
	@Transient
	private String outactname, oubbzname, outcustomername, outlibname, datamanname;

	@Transient
	private String outsl, outtypename;
	@Transient
