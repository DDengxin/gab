package com.tengzhi.business.finance.financialBooks.accountBalanceSheet.service.impl;
...
import com.tengzhi.business.finance.financialBooks.accountBalanceSheet.dao.AccountBalanceSheetReportDao;
...
@Service
@Transactional
public class AccountBalanceSheetServiceImpl implements AccountBalanceSheetService {


    @Autowired
    private AccountBalanceSheetReportDao accountBalanceSheetDao;
    ...
    public BasePage<payment> findAll(BaseDto baseDto) throws IOException, ParseException {
        ...
        return accountBalanceSheetDao.QueryToBeanPage(baseDto, sql);
    }
}
