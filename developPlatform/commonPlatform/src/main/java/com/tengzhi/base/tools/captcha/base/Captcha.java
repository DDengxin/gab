...
public abstract class Captcha
    ...
    public void setFont(int font, int style, float size) throws IOException, FontFormatException {
        this.font = Font.createFont(0, getClass().getResourceAsStream("/" + FONT_NAMES[font])).deriveFont(style, size);
    }
...
/* Location:              D:\Program Files\maven\.m2\repository\com\github\whvcse\easy-captcha\1.6.2\easy-captcha-1.6.2.jar!\com\wf\captcha\base\Captcha.class
